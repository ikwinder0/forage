                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-header pt-7" id="kt_chat_contacts_header">
                            ...
                            <div class="card-title">
                                ...
                                Analytics <a href="{{url('forage/export-single-analytics/'.$single_url_analytics_id)}}" style="margin-left: 20px;" class="ml-4 btn btn-sm btn-primary">Export Data</a>
                                <!--end::Svg Icon-->
                            </div>
                            <!--end::Card title-->
                        </div>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5">
                                    <thead>
                                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th scope="col"><strong>Short Link</strong></strong></th>
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($data as $item)
                                            <tr>
                                                ...
                                                <th scope="row">{{$item->shortLink->short_link}}</th>
                                                <td>{{$item->ip}}</td>
                                                <td>{{$item->country}}</td>
                                                <td>{{$item->state}}</td>
                                                <td>{{$item->city}}</td>
                                                ...
                                                <td>{{$item->utm_parameter_content}}</td>                                            </tr>
                                            @php
                                                $count++;
                                            @endphp
                                            @empty
