...
<html lang="en">
    <!--begin::Head-->
    <head><base href="../../../">
        <title>Admin Panel | ShortLinks</title>
        <meta charset="utf-8" />
        ...
        <!--end::Fonts-->
        <!-- {{asset('assets/theme/css/bootstrap-material.min.css')}} -->
        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url({{asset('assets/media/illustrations/sketchy-1/14.png')}}">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                    <!--begin::Logo-->
                    <a href="#" class="mb-12">
                        <img alt="Logo" src="{{asset('assets/media/logos/logo-1.png')}}" class="w-250px" />
                    </a>
                     
                    <!--end::Logo-->
                    <!--begin::Wrapper-->
                    <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                        @include('navbar.flash-message')
                        <!--begin::Form-->
                        <!-- <form  novalidate="novalidate" id="kt_sign_in_form" method="post" action="{{route('admin-login')}}"> -->
                            ...
                            <div class="text-center mb-10">
                                ...
                                <!-- <h1 class="text-dark mb-3">Sign In to ShortLinks</h1> -->
                                <!--end::Title-->
                                <!--begin::Link-->
